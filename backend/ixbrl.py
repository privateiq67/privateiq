...
CONCEPT_MAP: dict[str, tuple[str, str]] = {
    ...
    # Cash flow — operating (FRS 102 / IFRS / UK common local-names)
    ...
    "NetCashFlowsFromOperatingActivities": ("cash_flow", "Operating CF"),
    "NetCashFromOperatingActivities": ("cash_flow", "Operating CF"),
    "CashFlowsFromOperatingActivities": ("cash_flow", "Operating CF"),
    "NetCashGeneratedFromOperations": ("cash_flow", "Operating CF"),
    "NetCashGeneratedFromUsedInOperations": ("cash_flow", "Operating CF"),
    "NetCashGeneratedFromUsedInOperatingActivities": ("cash_flow", "Operating CF"),
    "CashGeneratedFromOperations": ("cash_flow", "Operating CF"),
    "NetCashInflowFromOperatingActivities": ("cash_flow", "Operating CF"),
    "NetCashOutflowFromOperatingActivities": ("cash_flow", "Operating CF"),
    "NetCashInflowOutflowFromOperatingActivities": ("cash_flow", "Operating CF"),
    "NetCashUsedInOperatingActivities": ("cash_flow", "Operating CF"),
    ...
    "NetCashFlowsFromInvestingActivities": ("cash_flow", "Investing CF"),
    "NetCashFromInvestingActivities": ("cash_flow", "Investing CF"),
    "CashFlowsFromInvestingActivities": ("cash_flow", "Investing CF"),
    "NetCashUsedInInvestingActivities": ("cash_flow", "Investing CF"),
    "NetCashInflowFromInvestingActivities": ("cash_flow", "Investing CF"),
    "NetCashOutflowFromInvestingActivities": ("cash_flow", "Investing CF"),
    ...
    "NetCashFlowsFromFinancingActivities": ("cash_flow", "Financing CF"),
    "NetCashFromFinancingActivities": ("cash_flow", "Financing CF"),
    "CashFlowsFromFinancingActivities": ("cash_flow", "Financing CF"),
    "NetCashUsedInFinancingActivities": ("cash_flow", "Financing CF"),
    "NetCashInflowFromFinancingActivities": ("cash_flow", "Financing CF"),
    "NetCashOutflowFromFinancingActivities": ("cash_flow", "Financing CF"),
    ...
    "NetIncreaseDecreaseInCashAndCashEquivalentsBeforeExchangeRateMovements": (
        "cash_flow",
        "Net Change in Cash",
    ),
    ...
    "NetIncreaseInCashAndCashEquivalents": ("cash_flow", "Net Change in Cash"),
    "NetDecreaseInCashAndCashEquivalents": ("cash_flow", "Net Change in Cash"),
    "IncreaseDecreaseInCash": ("cash_flow", "Net Change in Cash"),
}
